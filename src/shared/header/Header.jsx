...
<NavLink className='npnav '>Home</NavLink>
    ...
    return (
        <div className='w-3/4 flex justify-between mx-auto py-6 '>
           <div className="flex w-full px-4  items-center justify-between bg-base-100">
  <div className=" ">
...
<div className="navbar-end bg-np w-40 py-8 px-6 text-white">
